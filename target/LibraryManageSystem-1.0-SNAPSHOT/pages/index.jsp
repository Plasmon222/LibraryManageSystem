<%@ page import="com.chun.pojo.Admin" %>
        ...
        <div class="layuimini-header-content" >
            ...
            <ul class="layui-nav layui-layout-right ">
                ...
                <li class="layui-nav-item layuimini-setting">
                    <a href="javascript:;"><span style="color: #BBBBBB">${user.username}
<%--                   <%--%>
...
<%--                   %>--%>
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="#" layuimini-content-href="${pageContext.request.contextPath}/updatePassword" data-title="人脸注册" data-icon="fa fa-gears">人脸注册</a>
                        </dd>
                        <dd>
                            <hr>
                        </dd>
        ...
        var options = {
            <c:choose>
                <c:when test="${sessionScope.type.equals('reader')}">
                    iniUrl: "api/init2.json",    // 初始化接口，读者
                </c:when>
                <c:otherwise>
