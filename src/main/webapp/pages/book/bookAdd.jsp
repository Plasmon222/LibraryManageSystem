...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="type_id" id="typeId" lay-verify="required">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="publish_date" id="date" lay-verify="date" autocomplete="off" class="layui-input">
        </div>
    </div>
...
<script>
    layui.use(['form','laydate','table'], function () {
        ...
        let localCategory = JSON.parse(localStorage.getItem("categoryData"))
        // console.log("=======")
        // console.log(localCategory)
        // console.log("========")
        var list=localCategory;
        // console.log("图书分类2")
        var select=document.getElementById("typeId");
        if(list!=null|| list.size()>0){
            for(var c in list){
