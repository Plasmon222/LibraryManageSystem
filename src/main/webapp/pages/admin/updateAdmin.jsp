...
<%--    type="hidden"--%>
<%--    <input  name="id"  value="${upAdmin.id}">--%>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <input type="password" name="newPwd" id="newPwd" lay-verify="required" lay-reqtext="新密码不能为空" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label required">确认新密码</label>
        <div class="layui-input-block">
            <input type="password" name="newPwdAgain" id="againPwd"  lay-verify="required" lay-reqtext="新密码不能为空" class="layui-input">
        </div>
    </div>
